...
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+DdA7K1sZHUk4MTA1')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002190681742').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://santoshdd:santoshdd@cluster0.1ofua.mongodb.net/")
DATABASE_NAME = environ.get('DATABASE_NAME', "santoshdd")
